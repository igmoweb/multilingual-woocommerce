...
if ( ! class_exists( 'Multilingual_Woocommerce_Admin_Page' ) ) {
abstract class Multilingual_Woocommerce_Admin_Page {
	...
	public function check_for_scripts( $hook ) {
		if ( $hook === $this->page_id ) {
			...
			try {
				...
				Multilingual_Woocommerce_Errors_Handler::show_exception( $e->getMessage() );
			}
